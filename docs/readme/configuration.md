...
| Inline slash commands          | Server plugin entry in `opencode.json`                                                    | `/quota`, `/quota_refresh`, `/quota_status`, `/quota_switch`, `/quota_announcements`, `/pricing_refresh`, and `/tokens_*` are registered once and shared by TUI and Desktop/server. They inject deterministic ignored/no-reply output without calling the model. The TUI plugin does not register command popups. |
...
| ----------------------------- | -------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `enabled`                     | `true`         | Master switch for quota collection and handled slash commands. When `false`, `/quota`, `/quota_refresh`, `/quota_status`, `/quota_switch`, `/pricing_refresh`, and `/tokens_*` are handled as no-ops.                                                                                              |
